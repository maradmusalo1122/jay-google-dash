...
const ENTRIES: Array<{
  ...
  {
    id: 'e-team-party', quarterId: 'q2-2026', authorId: 'u-jasmine', type: 'post',
    title: 'NBS SAPAC Team Party 🎉',
    caption: 'We closed the quarter the right way — the whole India + Singapore crew under one roof. Great food, a dance floor nobody wanted to leave, and a confetti drop the AV team absolutely nailed. Recharged and ready for next quarter.',
    tag: 'team_event', eventName: 'Quarterly Team Bash', eventDate: new Date('2026-04-08T17:00:00Z'),
    photos: set([
      [un('1530103862676-de8c9debad1d'), 'Confetti drop'],
      [un('1514525253161-7a46d19cd819'), 'The dance floor'],
      [un('1516450360452-9312f5e86fc7'), 'Cheers to the quarter'],
      [un('1470229722913-7c0e2dbbafd3'), 'Lights down, music up'],
    ]),
...
const COMMENTS = [
  ...
  { id: 'c-4', entryId: 'e-team-party', userId: 'u-abhishek', body: 'Best night of the quarter, hands down 🙌', createdAt: new Date('2026-04-10T20:30:00Z') },
  { id: 'c-5', entryId: 'e-team-party', userId: 'u-priya', body: 'That dance floor 🔥🔥🔥', createdAt: new Date('2026-04-11T06:00:00Z') },
...
const REACTIONS = [
  ...
  ...likes('e-team-party', ['u-abhishek', 'u-priya', 'u-tina', 'u-aditya', 'u-gunjeeta', 'u-nikhil', 'u-ramneek'], new Date('2026-04-10T21:00:00Z')),
